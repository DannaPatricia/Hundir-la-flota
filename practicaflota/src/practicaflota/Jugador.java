...
public class Jugador {
        ...
        do {
            try {
                ...
                if (coordenada1 > 9 || coordenada1 < 0) {
                    System.out.println(
                            ANSI_GREEN + "Coordenada no v�lida, debe estar comprendido entre 0 y 9." + ANSI_RESET);
                    valido = false;
                } else {
                    valido = true;
                }
            } catch (InputMismatchException e) {
                System.out.println(ANSI_GREEN + "Coordenada no v�lida, introduzca un n�mero." + ANSI_RESET);
                sc.next();
            }
        } while (valido == false);
        return coordenada1;
        ...
        do {
            try {
                ...
                if (coordenada2 > 9 || coordenada2 < 0 || caracter.length() > 1) {
                    System.out.println(ANSI_GREEN + "Coordenada no v�lida, introduce una letra (A - J)." + ANSI_RESET);
                    valido = false;
                } else {
                    valido = true;
                }
            } catch (Exception e) {
                System.out.println(ANSI_GREEN + "Coordenada no v�lida, introduce una letra." + ANSI_RESET);
                sc.next();
            }
        } while (valido == false);
        return coordenada2;
    ...
    public String validarSentido() {
        ...
        do {
            ...
            if (sentido.length() > 1) {
                System.out.println(ANSI_GREEN + "Sentido no v�lido, introduzca V o H" + ANSI_RESET);
    ...
    public void pedirCoordenadas() {
        ...
        for (int i = 0; i < velero.length; i++) {
            System.out.println("Vas a colocar " + (velero.length - i) + " veleros(tama�o 1):");
        ...
        for (int i = 0; i < buque.length; i++) {
            System.out.println("Vas a colocar " + (buque.length - i) + " buques(tama�o 3):");
            int coordenada1 = validarCoordenada1();
            int coordenada2 = validarCoordenada2();
            String sentido = validarSentido();
        ...
        for (int i = 0; i < fragata.length; i++) {
            System.out.println("Vas a colocar " + (fragata.length - i) + " fragatas(tama�o 2):");
            int coordenada1 = validarCoordenada1();
            int coordenada2 = validarCoordenada2();
            String sentido = validarSentido();
        ...
        for (int i = 0; i < portaviones.length; i++) {
            System.out.println("Vas a colocar 1 portaviones(tama�o 4):");
            int coordenada1 = validarCoordenada1();
            int coordenada2 = validarCoordenada2();
            String sentido = validarSentido();
